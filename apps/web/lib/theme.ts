...
export const publicFormInputClass =
  "mt-1.5 w-full rounded-lg border border-facil-border bg-facil-card px-3 py-2.5 text-base text-foreground shadow-sm transition placeholder:text-facil-muted focus:border-facil-orange focus:outline-none focus:ring-2 focus:ring-facil-orange/20 disabled:opacity-60";

export const publicFormLabelClass = "block text-sm font-medium text-foreground";

export const publicFormInputSimpleClass =
  "mt-1 w-full rounded border border-facil-border bg-facil-card px-3 py-2 text-base text-foreground";
