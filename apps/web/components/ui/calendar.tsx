  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday: "text-facil-muted w-9 font-normal text-[0.8rem] text-center",
        week: "flex w-full mt-2",
        day: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20",
        day_button: cn(
          "size-9 p-0 font-normal rounded-md hover:bg-facil-surface",
        ...
        today: "bg-facil-surface text-foreground",
        outside: "text-facil-muted opacity-50",
        disabled: "text-facil-muted opacity-50",
        range_middle:
          "aria-selected:bg-facil-orange-light rounded-none",
