...
_DEFER_UTTERANCE = re.compile(
    ...
    r"depois.{0,24}vejo.{0,24}(documentos?|comprovantes?|cnh|docs)|"
    r"n[aã]o\s+tenho\s+(agora|no\s+momento).{0,24}"
    r"(documentos?|comprovantes?|cnh|docs)|"
    r"n[aã]o\s+estou\s+com\s+(os\s+)?documentos|"
    r"n[aã]o\s+tenho\s+(os\s+)?documentos|"
    r"n[aã]o\s+tenho\s+(os\s+)?comprovantes|"
    r"n[aã]o\s+tenho\s+(a\s+)?(cnh|holerite|comprovante)|"
    r"estou\s+sem\s+(a\s+|os\s+)?(documenta[cç][aã]o|documentos|comprovantes)|"
    r"sem\s+(a\s+|os\s+)?(documenta[cç][aã]o|documentos|comprovantes).{0,24}"
    r"(agora|momento|m[aã]os)|"
